...
\todo{wprowadzić aparat matematyczny taki jak paretooptymalność, wytłumaczyć co to są za zbiory}

\todo{tu opisać algorytm negocjacji pomiędzy agentami}

\todo{wstawić rysunek ze schematem algorytmu, dokonac minimalizacji stanow}